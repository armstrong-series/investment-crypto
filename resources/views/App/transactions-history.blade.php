                                                ...
                                                <div class="card-body row align-items-center">
                                                 <div class="row row-cols-auto g-3">
                                                    ...
                                                    <div class="col">
                                                     ...
                                                     <div class="col">
                                                         <button v-cloak type="button" @data-toggle="tooltip" data-placement="top" title="Delete" class="btn text-secondary"><img src="{{ asset('UI-assets/icons/trash.svg')}}" width="40" height="40" alt=""> </button>
                                                     </div>       
